        ...
        <div>
            {
                props.addQuestion && (
                    <div className={qesForm.selectType}>
                        <h2>Question Type</h2>
                        <ul>
                            <li onClick={() => TypeIsSelected(setMultipleChoices, multipleChoices)}>Multiplessssssssss Choices</li>
                            <li onClick={() => TypeIsSelected(setTrueFalse, trueFalse)}>True ORssssssssss False</li>
                            <li onClick={() => TypeIsSelected(setOpenEnded, openEnded)}>Opensssssssssssss Ended</li>
                        </ul>
                    </div>
                )
            }
